...
public class EmployeeDAO {
	...
	public int save(String Uemail, String Ufname, String Ulname, String UserName, String Password, String gen,
		...
		try {
			...
			String query = "insert into employee(email,firstname,lastName,username,passwd,gender,experience,industry,keySkills) values(?,?,?,?,?,?,?,?,?)";
	...
	public static int update(Employee e, String Umail) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(
					"UPDATE employee SET FirstName= ?, LastName=?, UserName=?, passwd=?, Gender= ?, experience = ?,  Industry= ?, keySkills =? WHERE email =? ");
