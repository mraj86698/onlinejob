		...
		<table>
			<table>
				...
				<tr>
					...
					<td align="right" valign="top"><span class="txt_orange"></span>Vacancy:<input type="text" name="vac" value=""></td>
					
					<td align="right" valign="top"><span class="txt_orange"></span>Skills Required
					<input type="text" name="skill" value=""><td/>
